...
const placeOrder = "http://localhost:8080/orders";
...
class PlaceOrder extends Component {
    ...
    handleCheckout = () => {
        let obj = this.state;//over- writting the id

        obj.menuItem = sessionStorage.getItem('menu');//getting the menuItem from sessionStorage menu data
        fetch(placeOrder,{
            method:'POST',
            headers: {
        ...
        .then(this.props.history.push(`/viewBooking`))//routing to next page ie.,viewBooking page
    }
